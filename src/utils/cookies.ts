...
export const setBreadList = (breadList: string) => sessionStorage.setItem(BreadList, breadList)
export const removeBreadList = () => sessionStorage.removeItem(BreadList)

export const getMenuList = () => sessionStorage.getItem(MenuList)
export const setMenuList = (breadList: string) => sessionStorage.setItem(MenuList, breadList)
